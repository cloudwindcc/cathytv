# CathyTV - 免费在线视频搜索与观看平台

<div align="center">
  <img src="image/logo.png" alt="CathyTV Logo" width="120">
  <br>
...
CathyTV 是 Cathy.WANG 站点体系下的在线视频搜索与观看平台，正式访问域名为 <https://tv.cathy.wang/>。它提供来自多个视频源的内容搜索与播放服务，无需注册，即开即用，支持多种设备访问。

本项目复刻自 [cloudwindcc/TV](https://github.com/cloudwindcc/TV)，并将面向用户的品牌与站点链接替换为 CathyTV / cathy.wang。
...
选择以下任一平台，即可快速创建自己的 CathyTV 实例：

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fcloudwindcc%2Fcathytv)
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/cloudwindcc/cathytv)
[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/cloudwindcc/cathytv)
...
要为您的 CathyTV 实例添加密码保护，可以在部署平台上设置环境变量：
...
CathyTV 支持标准的苹果 CMS V10 API 格式。添加自定义 API 时需遵循以下格式：
...
CathyTV 仅作为视频搜索工具，不存储、上传或分发任何视频内容。所有视频均来自第三方 API 接口提供的搜索结果。如有侵权内容，请联系相应的内容提供方。
