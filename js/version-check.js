...
async function checkForUpdates() {
    try {
        ...
        let latestVersion;
        const VERSION_URL = {
            PROXY: 'https://raw.ihtw.moe/raw.githubusercontent.com/cloudwindcc/cathytv/main/VERSION.txt',
            DIRECT: 'https://raw.githubusercontent.com/cloudwindcc/cathytv/main/VERSION.txt'
        };
            ...
            setTimeout(() => {
                ...
                if (updateBtn) {
                    updateBtn.addEventListener('click', () => {
                        window.open('https://github.com/cloudwindcc/cathytv', '_blank');
                    });
                }
            }, 100);
        } else {
